...
#import "GridLayout.h"
#import "AlbumLayoutAttributes.h"
...
{
    return [AlbumLayoutAttributes class];
}
...
- (NSArray *)layoutAttributesForElementsInRect:(CGRect)rect
{
    ...
    for (UICollectionViewLayoutAttributes *attributes in array)
    {
        ...
        if (attributes.representedElementCategory == UICollectionElementCategorySupplementaryView && [attributes isKindOfClass:[AlbumLayoutAttributes class]])
        {
            AlbumLayoutAttributes *albumAttributes = (AlbumLayoutAttributes *)attributes;
            albumAttributes.headerTextAlignment = NSTextAlignmentLeft;
        }
    }
